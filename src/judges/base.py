...
# --- CLI entry point (replaces run_judges.py) ---

def main():
    """Run judges for an eval run.

    Usage:
        python base.py <scenario-dir> <workdir> <results-dir> <model> [judge1,judge2,...]
    """
    import sys
    import yaml

    if len(sys.argv) < 5:
        print("Usage: python base.py <scenario-dir> <workdir> <results-dir> <model> [judges]")
        sys.exit(1)
